...
{
    if ($i == 0) {
	    echo 'document.write(\'<img id="img_fun" src="'.$base_url . $style_dir . substr($count,$i,1) . '.' . $ext .'" border="0" />\');';
	} elseif ($i == 1) {
	    echo 'document.write(\'<img id="img_log" src="'.$base_url . $style_dir . substr($count,$i,1) . '.' . $ext .'" border="0" />\');';
	} else {
